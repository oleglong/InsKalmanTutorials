...
plot_sectors( 0.04 )
plt.legend( ( line1, line3 ), ( 'Истинное значение', 'Оценка' ) )
...
plot_sectors( 0.1 )
plt.legend( ( line1, line2, line3 ), ( 'Истинное значение', 'ВНС', 'Оценка' ) )
...
plt.legend( ( line1, line2 ), ( 'Истинное значение', 'Оценка' ) )
plot_sectors( 5 )
